...
var optionalArgs = [
  ...
  { arg: "to-json", type: "flag", option: "toJason", desc: "Convert." },
  {
    ...
    option: "compact",
    desc:
      "Compact JSON form (see explanation in www.npmjs.com/package/xml-js).",
  },
  {
    arg: "spaces",
    type: "number",
  ...
  // { arg: 'sanitize', type: 'flag', option:'sanitize', desc: 'Special xml characters will be replaced with entity codes.' },
  {
    ...
    option: "nativeType",
    desc:
      "Numbers and boolean will be converted (coerced) to native type instead of text.",
  },
  {
    arg: "always-array",
    type: "flag",
    option: "alwaysArray",
    desc:
      "Every element will always be an array type (applicable if --compact is set). If the passed value is an array, only elements with names in the passed array are always made arrays.",
  },
  {
    arg: "always-children",
    type: "flag",
    ...
    desc:
      "Every element will always contain sub-elements (applicable if --compact is not set).",
  },
  {
  ...
  },
  {
    ...
    option: "typeKey",
    desc:
      "To change the default 'type' key (applicable if --compact is not set).",
  },
  {
    arg: "name-key",
    type: "string",
    option: "nameKey",
    desc:
      "To change the default 'name' key (applicable if --compact is not set).",
  },
  {
    arg: "elements-key",
    type: "string",
    option: "elementsKey",
    desc:
      "To change the default 'elements' key (applicable if --compact is not set).",
  },
];
