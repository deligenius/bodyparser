...
// Declaration
const declarationCompact1: ElementCompact = {
  _declaration: { _attributes: { version: 2 } },
};
const declarationCompact2: ElementCompact = {
  _declaration: {
    _attributes: { version: "1.0", encoding: "utf-8", standalone: "yes" },
  },
};
const declaration1: Element = { declaration: {} };
const declaration2: Element = {
  declaration: {
...
const elementCompact2: ElementCompact = {
  a: { _attributes: { x: "1.234", y: "It's", z: undefined } },
};
  ...
  elements: [
    {
      type: "element",
      name: "a",
      attributes: { x: "1.234", y: "It's", z: undefined },
    },
  ],
};
...
const element3: Element = {
  elements: [
    { type: "element", name: "a", elements: [{ type: "text", text: " Hi " }] },
  ],
};
...
const element5: Element = {
  elements: [
    { type: "element", name: "a", elements: [{ type: "element", name: "b" }] },
  ],
};
...
// js2xml
let xmlResult1: string = convert.js2xml(
  { a: {} },
  { compact: true, spaces: 4 },
);
let xmlResult2: string = convert.js2xml(
  { elements: [{ type: "element", name: "a" }] },
  { compact: false },
);

// json2xml
let xmlResult3: string = convert.json2xml(
  '{"a":{}}',
  { compact: true, spaces: 4 },
);
let xmlResult4: string = convert.json2xml(
  '{"elements":[{"type":"element","name":"a"}]}',
  { compact: false },
);
