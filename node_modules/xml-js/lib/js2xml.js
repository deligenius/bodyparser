  ...
  for (key in attributes) {
    if (
      ...
      attrName = "attributeNameFn" in options
        ? options.attributeNameFn(key, attr, currentElementName, currentElement)
        : key;
      result.push(
      ...
      result.push(
        attrName + "=" + quote + ("attributeValueFn" in options
...
function writeInstruction(instruction, options, depth) {
  ...
  if (typeof instruction[key] === "object") {
    ...
    return "<?" + instructionName +
      writeAttributes(instruction[key][options.attributesKey], options, depth) +
      "?>";
  } else {
